...
if __name__ == "__main__":
    ngrok.set_auth_token("2jSRs67bA4sbJvsdXFDz5um5fGd_3qE1VThH7MDm4xd2zQYLV")
    tunnel = ngrok.connect(8080)
    public_url = tunnel.public_url
    print(f"Public URL: {public_url}")

    local_ip = socket.gethostbyname(socket.gethostname())
    start_server(main, debug=True, port=8080, cdn=False, remote_access=True, remote_ip=local_ip)
